...
Checklist framework for assessing and improving decision quality

## Overview

This repository provides resources and tools for decision quality checklist.
...
3. Apply frameworks to your decision quality checklist projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores decision quality checklist concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
